...
type GetServiceAccess200JSONResponse externalRef0.ServiceAccess
...
type GetServiceAccess404ResponseHeaders struct {
	XRequestId *string
}

type GetServiceAccess404JSONResponse struct {
	Body    externalRef0.ErrorResponse
	Headers GetServiceAccess404ResponseHeaders
}
...
type PutServiceAccess200JSONResponse externalRef0.ServiceAccess
...
type PutServiceAccess404ResponseHeaders struct {
	XRequestId *string
}

type PutServiceAccess404JSONResponse struct {
	Body    externalRef0.ErrorResponse
	Headers PutServiceAccess404ResponseHeaders
}
...
type PutServiceAccess409ResponseHeaders struct {
	XRequestId *string
}

type PutServiceAccess409JSONResponse struct {
	Body    externalRef0.ErrorResponse
	Headers PutServiceAccess409ResponseHeaders
}
...
type ResolveServiceDrift200ResponseHeaders struct {
	Etag *externalRef0.ETag
}

type ResolveServiceDrift200JSONResponse struct {
	Body    externalRef0.Service
	Headers ResolveServiceDrift200ResponseHeaders
}
...
type ResolveServiceDrift404ResponseHeaders struct {
	XRequestId *string
}

type ResolveServiceDrift404JSONResponse struct {
	Body    externalRef0.ErrorResponse
	Headers ResolveServiceDrift404ResponseHeaders
}
...
type ResolveServiceDrift409ResponseHeaders struct {
	XRequestId *string
}

type ResolveServiceDrift409JSONResponse struct {
	Body    externalRef0.ErrorResponse
	Headers ResolveServiceDrift409ResponseHeaders
}
