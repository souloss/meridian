...
export const getListBreakingTodosResponseMock = (overrideResponse: Partial<Extract<BreakingTodoPage, object>> = {}): BreakingTodoPage => ({total: faker.number.int({min: 0}), page: faker.number.int({min: 1}), pageSize: faker.number.int({min: 1, max: 100}), items: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), assetVersionId: faker.string.uuid(), serviceId: faker.string.uuid(), status: faker.helpers.arrayElement(Object.values(TodoStatus)), summary: {added: faker.number.int({min: 0}), removed: faker.number.int({min: 0}), modified: faker.number.int({min: 0}), breaking: faker.number.int({min: 0}), risky: faker.number.int({min: 0}), nonBreaking: faker.number.int({min: 0}), informational: faker.number.int({min: 0})}, ackedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), comment: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), createdAt: faker.date.past().toISOString().slice(0, 19) + 'Z', acknowledgedAt: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,])})), ...overrideResponse})

/** getAcknowledgeBreakingTodoResponseMock provides generated MSW behavior for contract tests. */
export const getAcknowledgeBreakingTodoResponseMock = (overrideResponse: Partial<Extract<BreakingTodo, object>> = {}): BreakingTodo => ({id: faker.string.uuid(), assetVersionId: faker.string.uuid(), serviceId: faker.string.uuid(), status: faker.helpers.arrayElement(Object.values(TodoStatus)), summary: {added: faker.number.int({min: 0}), removed: faker.number.int({min: 0}), modified: faker.number.int({min: 0}), breaking: faker.number.int({min: 0}), risky: faker.number.int({min: 0}), nonBreaking: faker.number.int({min: 0}), informational: faker.number.int({min: 0})}, ackedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), comment: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), createdAt: faker.date.past().toISOString().slice(0, 19) + 'Z', acknowledgedAt: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), ...overrideResponse})
